...
def random_pause(min_duration=0.3, max_duration=1.0):
    silence_duration = random.uniform(min_duration, max_duration)
    silence = np.zeros(int(silence_duration * sample_rate))
    return silence


kokoro = Kokoro("./model_files/kokkoro-82m/kokoro-v1.0.onnx", "./model_files/kokkoro-82m/voices/voices-v1.0.bin")
